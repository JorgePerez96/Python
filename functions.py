...
print_name(lastname="Perez", name="Jorge")

#Funcion con parametros de entrada/argumentos por defecto

def print_name_with_default(name, lastname, alias="George"):
    print(f"{name} {lastname} {alias}")
    
    
print_name_with_default("Jorge", "Perez")
print_name_with_default("Jorge", "Cerrillo", "Perez")
